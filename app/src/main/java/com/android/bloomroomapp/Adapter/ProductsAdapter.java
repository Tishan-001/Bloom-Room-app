package com.android.bloomroomapp.Adapter;
...
import com.android.bloomroomapp.Activity.ProductDetailsActivity;
import com.android.bloomroomapp.Admin.NewProductActivity;
...
public class ProductsAdapter extends RecyclerView.Adapter<ProductsAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ProductsAdapter.MyViewHolder holder, int position) {
        ...
        holder.price.setText("R.S " + product.getPrice());
