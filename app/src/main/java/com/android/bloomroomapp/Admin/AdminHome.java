...
import com.android.bloomroomapp.Activity.LoginActivity;
...
public class AdminHome extends AppCompatActivity {
    ...
    int counter = 0;
    private RelativeLayout logoutBtn, newProduct, viewProduct, newCategory, newOffer, viewCustomersOrders,viewfeedback,reports;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newOffer.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AdminHome.this, NewOfferActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void initAll() {
        ...
        newCategory = findViewById(R.id.new_category_layout);
        newOffer = findViewById(R.id.new_offer_layout);
