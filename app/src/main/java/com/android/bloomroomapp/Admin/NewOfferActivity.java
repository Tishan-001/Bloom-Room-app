...
//                if(isEdit){
//                    Toast.makeText(NewOfferActivity.this, "Category updated Successfully", Toast.LENGTH_SHORT).show();
//                }
//                else{
//                    Toast.makeText(NewOfferActivity.this, "Category added Successfully", Toast.LENGTH_SHORT).show();
//
//                }
//                finish();
