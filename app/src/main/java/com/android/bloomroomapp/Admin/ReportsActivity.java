...
import com.android.bloomroomapp.Model.Product;
import com.android.bloomroomapp.Model.Report;
...
public class ReportsActivity extends AppCompatActivity {
    ...
    private void getEntries() {
        ...
        if(reportArrayList.size()>0){
            ...
            int Sympathyflowers = 0;
            int Housewarmingflowers = 0;
            int Birthdayflowers = 0;
            int Anniversary = 0;
            int NewBaby = 0;
            int ValentinesDay = 0;
            int Graduation = 0;
            ...
            for(int i=0;i<reportArrayList.size();i++){
                ...
                Sympathyflowers = Sympathyflowers + reportArrayList.get(i).getSympathyflowers();
                Housewarmingflowers = Housewarmingflowers + reportArrayList.get(i).getHousewarmingflowers();
                Birthdayflowers = Birthdayflowers + reportArrayList.get(i).getBirthdayflowers();
                Anniversary = Anniversary + reportArrayList.get(i).getAnniversary();
                NewBaby = NewBaby + reportArrayList.get(i).getNewBaby();
                ValentinesDay = ValentinesDay + reportArrayList.get(i).getValentinesDay();
                Graduation = Graduation + reportArrayList.get(i).getGraduation();
                MothersDay = MothersDay + reportArrayList.get(i).getMothersDay();
            ...
            totalSell.setText("Total Sell : R.S: "+totalPrice);

            pieEntries.add(new PieEntry(Sympathyflowers, "Sympathyflowers", 0));
            pieEntries.add(new PieEntry(Housewarmingflowers, "Housewarmingflowers", 1));
            pieEntries.add(new PieEntry(Birthdayflowers, "Birthdayflowers", 2));
            pieEntries.add(new PieEntry(Anniversary, "Anniversary", 3));
            pieEntries.add(new PieEntry(NewBaby, "NewBaby", 4));
            pieEntries.add(new PieEntry(ValentinesDay, "ValentinesDay", 5));
            pieEntries.add(new PieEntry(Graduation, "Graduation", 6));
            pieEntries.add(new PieEntry(MothersDay, "MothersDay", 7));
