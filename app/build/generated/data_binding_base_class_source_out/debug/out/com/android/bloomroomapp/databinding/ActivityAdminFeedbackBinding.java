...
public final class ActivityAdminFeedbackBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityAdminFeedbackBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static ActivityAdminFeedbackBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityAdminFeedbackBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_admin_feedback, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityAdminFeedbackBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityAdminFeedbackBinding((RelativeLayout) rootView, cartBackArrow,
