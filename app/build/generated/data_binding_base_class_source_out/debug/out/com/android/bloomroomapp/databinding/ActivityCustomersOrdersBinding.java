...
public final class ActivityCustomersOrdersBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityCustomersOrdersBinding(@NonNull RelativeLayout rootView,
      @NonNull ImageView cartBackArrow, @NonNull RecyclerView cartRecyclerview,
      @NonNull TextView noProduct, @NonNull ProgressBar spinProgressBar,
  ...
  @NonNull
  public static ActivityCustomersOrdersBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityCustomersOrdersBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_customers_orders, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityCustomersOrdersBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCustomersOrdersBinding((RelativeLayout) rootView, cartBackArrow,
